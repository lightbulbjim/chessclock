...
byte dummySavedGame[48] =
{
	...
	10,		//  5 - left.firstPhase.delayTime.seconds (byte)
	2,		//  6 - left.firstPhase.delayType (enum)
	...
	40,		// 31 - right.firstPhase.moveLimit (byte)
	2,		// 32 - right.secondPhase.time.hours (byte)
